...
-- @@ERROR  is a global variable that contains the error number generated by the last INSERT/UPDATE/DELETE statement. Not TRIGGER BY select. 
    ...
    BEGIN -- {
        ...
        BEGIN -- {
            ...
            BEGIN -- { -- This BEGIN/END is needed, because of two SQL statements
                ...
                VALUES (@Description)
				IF @@ERROR <>0 --AN ERROR VALUE other than 0 means there is a problem
				BEGIN
